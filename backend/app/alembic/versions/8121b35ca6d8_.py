...
Revision ID: 8121b35ca6d8
Revises: 
Create Date: 2021-11-17 11:37:53.000060
...
def upgrade():
    ...
    sa.Column('channel_id', sa.BigInteger(), nullable=False),
    sa.ForeignKeyConstraint(['channel_id'], ['channels.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['member_id'], ['guild_members.id'], ondelete='CASCADE'),
